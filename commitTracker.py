...
def generate_commit_reports(i_repo_uri, i_begin_commit,
    ...
    l_reports = []
    try:
#        print "i_begin_commit: " + i_begin_commit
#        print "i_end_commit: " + i_end_commit
#        print "l_repo.default_branch: " + l_repo.default_branch
#        l_tags = l_repo.get_tags()
#        print "l_tags:" 
#        for l_tag in l_tags:
#            if l_tag.name == i_begin_commit:
#                i_begin_commit = l_tag.commit.sha
#            if l_tag.name == i_end_commit:
#                i_end_commit = l_tag.commit.sha
